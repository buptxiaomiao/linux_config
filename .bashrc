# tbj
alias tbj='~/bin/tbj.sh'
alias bvm='~/bin/bvm.sh'
alias v1='~/bin/v1.sh'
alias kaifa='~/bin/kaifa.sh'
alias kaifa3.1='~/bin/kaifa3.1.sh'
alias kaifa3.2='~/bin/kaifa3.2.sh'
...
alias ccc='nohup ~/Library/cherrytree/cherrytree& sleep 0.2;  echo "\n";'
